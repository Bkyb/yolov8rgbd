...
class Gif(nn.Module):
    def __init__(self, channels):
        ...
        self.conv_w1 = nn.LazyConv2d(1, kernel_size=3, padding=1)
        self.conv_w2 = nn.LazyConv2d(1, kernel_size=3, padding=1)

        self.conv_fusion = nn.LazyConv2d(0, kernel_size=1)
