...
class Gif(nn.Module):
    def __init__(self, channels):
        ...
        # self.conv_w1 = nn.Conv2d(channels * 2, 1, kernel_size=3, padding=1)
        # self.conv_w2 = nn.Conv2d(channels * 2, 1, kernel_size=3, padding=1)

        # self.conv_fusion = nn.Conv2d(channels * 2, channels * 2, kernel_size=1)
